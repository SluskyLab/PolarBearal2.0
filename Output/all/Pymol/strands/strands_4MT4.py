...
cmd.color("wheat","all")
cmd.select("Astrand0", "resi 84-96 & chain A ")
cmd.color ("red", "Astrand0")


cmd.select("Astrand1", "resi 109-124 & chain A ")
...
cmd.select("Bstrand4", "resi 84-96 & chain B ")
cmd.color ("yellow", "Bstrand4")


cmd.select("Bstrand5", "resi 109-124 & chain B ")
...
cmd.select("Cstrand8", "resi 84-96 & chain C ")
cmd.color ("orange", "Cstrand8")


cmd.select("Cstrand9", "resi 109-124 & chain C ")

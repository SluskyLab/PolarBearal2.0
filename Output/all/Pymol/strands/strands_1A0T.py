...
cmd.color("wheat","all")
cmd.select("Pstrand0", "resi 73-82 & chain P ")
...
cmd.select("Qstrand20", "resi 73-82 & chain Q ")
...
cmd.select("Rstrand40", "resi 73-82 & chain R ")
...
cmd.select("Rstrand50", "resi 256-265 & chain R ")

...
cmd.select("Astrand3", "resi 72-86 & chain A ")
cmd.color ("teal", "Astrand3")


cmd.select("Astrand4", "resi 91-107 & chain A ")
cmd.color ("yellow", "Astrand4")


cmd.select("Astrand5", "resi 113-132 & chain A ")
cmd.color ("blue", "Astrand5")


cmd.select("Astrand6", "resi 135-144 & chain A ")
cmd.color ("red", "Astrand6")


cmd.select("Astrand7", "resi 161-169 & chain A ")

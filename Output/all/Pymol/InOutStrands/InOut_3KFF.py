...
cmd.select("Astrand1", "resi 41+42+43+44+45+46+47 & chain A ")
...
cmd.select("Astrand5", "resi 87+88+89+90+91+92+93+94+95 & chain A ")
...
cmd.load_cgo( [9.0, 18.97625,-30.206625,14.0825, 5.51575, -31.712626, 2.36375, 1, 1,1,0,0,0,1], "axis" )

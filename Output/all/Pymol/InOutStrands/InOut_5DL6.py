...
cmd.select("Astrand8", "resi 181+182+183+184+185+186+187+188+189+190+191 & chain A ")


cmd.select("Astrand9", "resi 194+195+196+197+198+199+200+201+202+203 & chain A ")


cmd.select("Astrand10", "resi 207+208+209+210+211+212+213+214+215+216+217+218+219 & chain A ")


cmd.select("Astrand11", "resi 224+225+226+227+228+229+230+231+232+233+234+235 & chain A ")
...
cmd.select("Astrand14", "resi 302+303+304+305+306+307+308+309+310+311 & chain A ")


cmd.select("Astrand15", "resi 319+320+321+322+323+324+325+326+327+328+329+330+331+332+333 & chain A ")


cmd.select("Astrand16", "resi 338+339+340+341+342+343+344+345+346+347+348+349+350+351+352+353+354 & chain A ")


cmd.select("Astrand17", "resi 362+363+364+365+366+367+368+369+370+371+372+373 & chain A ")


cmd.select("Astrand18", "resi 384+385+386+387+388+389+390+391+392+393+394+395+396+397 & chain A ")
...
cmd.load_cgo( [9.0, 29.089058,41.44622,37.020668, 29.089058, 41.44622, 37.020668, 1, 1,1,0,0,0,1], "axis" )

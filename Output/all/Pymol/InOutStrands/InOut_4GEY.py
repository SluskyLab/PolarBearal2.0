...
cmd.select("Astrand9", "resi 233+234+235+236+237+238+239+240+241+242+243+244 & chain A ")


cmd.select("Astrand12", "resi 273+274+275+276+277+278+279+280+281+282+283 & chain A ")


cmd.select("Astrand13", "resi 294+295+296+297+298+299+300+301+302+303+304 & chain A ")


cmd.select("Astrand14", "resi 311+312+313+314+315+316+317+318+319+320+321+322 & chain A ")


cmd.select("Astrand15", "resi 332+333+334+335+336+337+338+339+340+341+342 & chain A ")


cmd.select("Astrand16", "resi 373+374+375+376+377+378+379+380+381+382+383+384 & chain A ")


cmd.select("Astrand17", "resi 389+390+391+392+393+394+395+396+397+398+399 & chain A ")


cmd.select("Astrand18", "resi 410+411+412+413+414+415+416+417+418+419+420 & chain A ")
...
cmd.load_cgo( [9.0, 23.792,44.352562,73.3235, 23.792, 44.352562, 73.3235, 1, 1,1,0,0,0,1], "axis" )

...
cmd.select("Astrand1", "resi 82+83+84+85+86+87+88 & chain A ")


cmd.select("Astrand2", "resi 91+92+93+94+95+96 & chain A ")


cmd.select("Astrand3", "resi 99+100+101+102+103+104+105+106+107+108+109+110+111+112+113+114 & chain A ")


cmd.select("Astrand4", "resi 120+121+122+123+124+125+126+127+128 & chain A ")


cmd.select("Astrand5", "resi 138+139+140+141+142 & chain A ")


cmd.select("Astrand6", "resi 154+155+156+157+158+159 & chain A ")


cmd.select("Astrand7", "resi 175+176+177+178 & chain A ")
...
cmd.load_cgo( [9.0, 10.180374,16.587873,-1.7197499, 19.753, 11.163, 3.16625, 1, 1,1,0,0,0,1], "axis" )

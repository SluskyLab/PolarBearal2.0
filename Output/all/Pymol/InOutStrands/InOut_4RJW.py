...
cmd.select("Astrand13", "resi 274+275+276+277+278+279+280+281+282+283+284+285+286+287 & chain A ")


cmd.select("Astrand14", "resi 295+296+297+298+299+300+301+302+303+304+305+306+307 & chain A ")


cmd.select("Astrand17", "resi 334+335+336+337+338+339+340+341+342+343+344+345+346+347+348 & chain A ")


cmd.select("Astrand18", "resi 363+364+365+366+367+368+369+370+371+372+373+374+375 & chain A ")
...
cmd.load_cgo( [9.0, 28.543373,9.261562,32.08725, 28.543373, 9.261562, 32.08725, 1, 1,1,0,0,0,1], "axis" )

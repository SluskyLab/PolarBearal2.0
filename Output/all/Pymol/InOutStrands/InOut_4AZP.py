...
cmd.select("Astrand1", "resi 42+43+44+45+46+47+48 & chain A ")


cmd.select("Astrand2", "resi 51+52+53+54+55+56+57 & chain A ")


cmd.select("Astrand3", "resi 62+63+64+65+66+67+68 & chain A ")


cmd.select("Astrand9", "resi 125+126+127+128+129+130+131+132+133 & chain A ")


cmd.select("Astrand8", "resi 115+116+117+118+119+120+121+122 & chain A ")


cmd.select("Astrand7", "resi 103+104+105+106+107+108+109+110+111+112 & chain A ")


cmd.select("Astrand6", "resi 93+94+95+96+97+98+99+100 & chain A ")


cmd.select("Astrand5", "resi 82+83+84+85+86+87+88+89+90 & chain A ")


cmd.select("Astrand4", "resi 73+74+75+76 & chain A ")
...
cmd.load_cgo( [9.0, 32.800125,9.648,13.666249, 22.7175, 19.230501, 2.5548751, 1, 1,1,0,0,0,1], "axis" )

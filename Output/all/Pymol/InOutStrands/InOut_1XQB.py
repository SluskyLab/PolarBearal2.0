...
cmd.color("wheat","all")
cmd.select("Astrand1", "resi 10+11+12+13 & chain A ")


cmd.select("Astrand2", "resi 33+34+35+36+37+38 & chain A ")


cmd.select("Astrand5", "resi 116+117+118+119+120+121+122+123 & chain A ")


cmd.select("Astrand4", "resi 100+101+102+103+104+105+106+107+108+109+110+111+112+113 & chain A ")


cmd.select("Astrand3", "resi 56+57+58+59+60+61+62 & chain A ")


cmd.select("Astrand6", "resi 131+132+133+134+135+136+137 & chain A ")
...
cmd.load_cgo( [9.0, 27.124334,21.959335,16.1735, 18.830835, 13.568001, 17.2605, 1, 1,1,0,0,0,1], "axis" )

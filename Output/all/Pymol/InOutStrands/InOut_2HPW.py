...
cmd.select("Astrand4", "resi 106+107+108+109+110+111+112+113+114+115+116 & chain A ")


cmd.select("Astrand3", "resi 93+94+95+96+97+98+99+100+101 & chain A ")


cmd.select("Astrand8", "resi 177+178+179+180+181+182+183+184+185+186+187+188 & chain A ")


cmd.select("Astrand7", "resi 161+162+163+164+165+166+167+168+169+170+171 & chain A ")


cmd.select("Astrand6", "resi 149+150+151+152+153+154+155+156 & chain A ")


cmd.select("Astrand9", "resi 200+201+202+203+204+205+206+207+208+209 & chain A ")


cmd.select("Astrand10", "resi 219+220+221+222+223+224+225+226+227+228+229 & chain A ")
...
cmd.load_cgo( [9.0, 12.237183,-14.011727,-43.710094, -5.7004547, -15.921728, -30.168818, 1, 1,1,0,0,0,1], "axis" )

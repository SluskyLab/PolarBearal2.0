...
cmd.select("Astrand9", "resi 128+129+130+131+132+133+134+135+136 & chain A ")


cmd.select("Astrand8", "resi 119+120+121+122+123+124+125 & chain A ")


cmd.select("Astrand7", "resi 107+108+109+110+111+112+113 & chain A ")


cmd.select("Astrand6", "resi 92+93+94+95+96+97+98+99 & chain A ")
...
cmd.load_cgo( [9.0, -2.8996253,-15.90775,-12.354501, 14.024875, -12.508375, -14.800749, 1, 1,1,0,0,0,1], "axis" )

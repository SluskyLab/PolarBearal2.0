...
cmd.select("Astrand7", "resi 148+149+150+151+152+153+154+155+156+157+158+159 & chain A ")


cmd.select("Astrand9", "resi 187+188+189+190+191+192+193+194+195+196+197 & chain A ")


cmd.select("Astrand10", "resi 200+201+202+203+204+205+206+207+208+209 & chain A ")


cmd.select("Astrand11", "resi 213+214+215+216+217+218+219+220+221+222+223+224+225 & chain A ")


cmd.select("Astrand12", "resi 230+231+232+233+234+235+236+237+238+239+240+241+242 & chain A ")


cmd.select("Astrand13", "resi 252+253+254+255+256+257+258+259+260+261+262+263+264 & chain A ")


cmd.select("Astrand14", "resi 267+268+269+270+271+272+273+274+275+276+277 & chain A ")


cmd.select("Astrand16", "resi 307+308+309+310+311+312+313+314+315+316 & chain A ")


cmd.select("Astrand17", "resi 325+326+327+328+329+330+331+332+333+334+335+336+337+338 & chain A ")


cmd.select("Astrand18", "resi 344+345+346+347+348+349+350+351+352+353+354+355+356+357 & chain A ")


cmd.select("Astrand19", "resi 367+368+369+370+371+372+373+374+375+376+377 & chain A ")


cmd.select("Astrand20", "resi 386+387+388+389+390+391+392+393+394+395+396+397+398 & chain A ")
...
cmd.load_cgo( [9.0, 40.332268,19.534998,47.318535, 40.332268, 19.534998, 47.318535, 1, 1,1,0,0,0,1], "axis" )

...
cmd.color("wheat","all")
cmd.select("Astrand1", "resi 28+29+30+31+32+33+34+35 & chain A ")


cmd.select("Astrand2", "resi 39+40+41+42+168+167+171+43+170+172+169+173+44+174+175+176+177+178+179+180 & chain A ")


cmd.select("Astrand8", "resi 141+142+143+144+145+146+147+148+149+150+151+152 & chain A ")


cmd.select("Astrand7", "resi 119+120+121+122+123+124+125+126+127+128+129+130+131+132+133+134 & chain A ")
...
cmd.select("Astrand4", "resi 60+61+62+63+64+65+66+67+68+69 & chain A ")


cmd.select("Astrand3", "resi 48+49+50+51+52+53+54+55 & chain A ")
...
cmd.load_cgo( [9.0, 2.2619998,-19.744572,24.849573, 5.5395713, 0.2861425, 38.243572, 1, 1,1,0,0,0,1], "axis" )

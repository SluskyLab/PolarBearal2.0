...
cmd.color ("blue", "resi 31 & chain C")

cmd.select ("Outward", "resi 31 & chain C", merge=1)

cmd.color ("blue", "resi 32 & chain C")

cmd.select ("Outward", "resi 32 & chain C", merge=1)

cmd.color ("blue", "resi 33 & chain C")

cmd.select ("Outward", "resi 33 & chain C", merge=1)
...
cmd.load_cgo( [9.0, -27.33475,1.9947499,24.001625, -30.5625, 10.023999, 28.50425, 1, 1,1,0,0,0,1], "axis" )

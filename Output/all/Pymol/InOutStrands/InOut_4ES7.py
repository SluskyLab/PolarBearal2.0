...
cmd.select("Astrand3", "resi 64+65+66+67+68+69+70+71+72+73+74 & chain A ")


cmd.select("Astrand4", "resi 80+81+82+83+84+85 & chain A ")


cmd.select("Astrand5", "resi 90+91+92+93+94+95+96+97+98+99 & chain A ")


cmd.select("Astrand6", "resi 104+105+106+107+108+109+110+111+112+113 & chain A ")
...
cmd.load_cgo( [9.0, 16.749626,-15.831,-7.2107496, 7.611, -1.9322499, -11.966499, 1, 1,1,0,0,0,1], "axis" )

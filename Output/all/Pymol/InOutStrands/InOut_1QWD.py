...
cmd.select("Astrand4", "resi 72+73+74+75+76+77+78+79+80 & chain A ")
...
cmd.select("Astrand9", "resi 138+139+140+141+142 & chain A ")


cmd.select("Astrand8", "resi 127+128+129+130+131 & chain A ")


cmd.select("Astrand7", "resi 112+113+114+115+116+117+118+119+120+121 & chain A ")


cmd.select("Astrand1", "resi 109+108+107+106+105+104+103+30+28+31+29 & chain A ")
...
cmd.load_cgo( [9.0, 3.8328753,35.63163,36.633003, 3.8328753, 35.63163, 36.633003, 1, 1,1,0,0,0,1], "axis" )

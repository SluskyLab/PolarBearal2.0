...
cmd.zoom("barrel")
cmd.color ("blue", "resi 13 & chain I")

cmd.select ("Outward", "resi 13 & chain I", merge=1)

cmd.color ("blue", "resi 14 & chain I")

cmd.select ("Outward", "resi 14 & chain I", merge=1)

cmd.color ("blue", "resi 15 & chain I")

cmd.select ("Outward", "resi 15 & chain I", merge=1)

cmd.color ("blue", "resi 16 & chain I")

cmd.select ("Outward", "resi 16 & chain I", merge=1)

cmd.color ("blue", "resi 17 & chain I")

cmd.select ("Outward", "resi 17 & chain I", merge=1)
...
cmd.color ("blue", "resi 30 & chain I")

cmd.select ("Outward", "resi 30 & chain I", merge=1)
...
cmd.load_cgo( [9.0, 52.052124,47.301872,-35.032875, 44.895874, 49.86, -27.770126, 1, 1,1,0,0,0,1], "axis" )

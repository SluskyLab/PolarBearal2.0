...
cmd.select("Astrand2", "resi 38+39+40+41+42+43+44+45 & chain A ")


cmd.select("Astrand1", "resi 29+30+31+32+33 & chain A ")
...
cmd.load_cgo( [9.0, 3.5653749,-4.24575,7.01475, 5.458875, 7.9487495, 7.4378753, 1, 1,1,0,0,0,1], "axis" )

...
cmd.select("Astrand10", "resi 29+30+31+32+163+33+162+164+165+34+166+35+167+168+169+170+171+172+173 & chain A ")


cmd.select("Astrand8", "resi 112+113+114+115+116+117+118+119+120+121+122+123+124+125+126+127 & chain A ")


cmd.select("Astrand7", "resi 99+100+101+102+103+104+105+106+107+108+109 & chain A ")


cmd.select("Astrand6", "resi 86+87+88+89+90+91+92+93+94+95+96 & chain A ")


cmd.select("Astrand3", "resi 38+39+40+41+42+43+44+45 & chain A ")


cmd.select("Astrand4", "resi 50+51+52+53+54+55+56+57+58 & chain A ")


cmd.select("Astrand9", "resi 134+135+136+137+138+139+140+141+142+143+144+145 & chain A ")
...
cmd.load_cgo( [9.0, 71.29237,32.153,-2.128625, 71.29237, 32.153, -2.128625, 1, 1,1,0,0,0,1], "axis" )

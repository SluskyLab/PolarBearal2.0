...
cmd.select("Astrand1", "resi 36+37+38+39+40+41+42+43+44 & chain A ")


cmd.select("Astrand2", "resi 49+50+51+52+53+54+55+56+57 & chain A ")


cmd.select("Astrand3", "resi 62+63+64+65+66+67+68+69+70+71 & chain A ")
...
cmd.select("Astrand6", "resi 96+97+98+99+100+101+102+103+104 & chain A ")


cmd.select("Astrand7", "resi 110+111+112+113+114+115+116+117+118 & chain A ")
...
cmd.load_cgo( [9.0, -24.82825,1.6185,-6.23225, -18.837126, -3.009375, -21.217627, 1, 1,1,0,0,0,1], "axis" )

...
cmd.select("Astrand2", "resi 47+48+49+50+51+52+53+54 & chain A ")


cmd.select("Astrand3", "resi 59+60+61+62+63+64+65 & chain A ")


cmd.select("Astrand9", "resi 118+119+120+121+122+123+124+125+126 & chain A ")


cmd.select("Astrand8", "resi 108+109+110+111+112+113+114+115 & chain A ")


cmd.select("Astrand7", "resi 98+99+100+101+102+103+104 & chain A ")


cmd.select("Astrand6", "resi 90+91+92+93+94+95 & chain A ")


cmd.select("Astrand5", "resi 80+81+82+83+84+85+86+87 & chain A ")


cmd.select("Astrand4", "resi 69+70+71+72 & chain A ")
...
cmd.load_cgo( [9.0, 39.74825,-2.321125,62.62125, 52.36162, -13.4685, 59.998753, 1, 1,1,0,0,0,1], "axis" )

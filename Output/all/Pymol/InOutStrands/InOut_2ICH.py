...
cmd.select("Astrand11", "resi 182+183+184+185+186+187+188+189+190+191+192+193+194+195+196+197+198+199 & chain A ")


cmd.select("Astrand12", "resi 203+204+205+206+207+208+209+210+211+212+213+214+215+216+217 & chain A ")


cmd.select("Astrand4", "resi 121+122+123 & chain A ")


cmd.select("Astrand7", "resi 143+144+145+146+147+148 & chain A ")
...
cmd.select("Astrand1", "resi 63+64+65+66+67+68+69+70+71+72+73 & chain A ")
...
cmd.load_cgo( [9.0, 16.731222,34.658554,12.484778, 16.731222, 34.658554, 12.484778, 1, 1,1,0,0,0,1], "axis" )

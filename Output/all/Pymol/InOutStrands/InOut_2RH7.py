...
cmd.select("Astrand5", "resi 118+119+120+121+122+123+124+125+126+127 & chain A ")
...
cmd.select("Astrand10", "resi 194+195+196+197+198+199+200+201+202+203+204 & chain A ")


cmd.select("Astrand11", "resi 213+214+215+216+217+218+219+220+221 & chain A ")


cmd.select("Astrand4", "resi 104+105+106+107+108+109+110+111+112+113 & chain A ")
...
cmd.load_cgo( [9.0, 28.83264,-21.454273,-16.803001, 28.83264, -21.454273, -16.803001, 1, 1,1,0,0,0,1], "axis" )

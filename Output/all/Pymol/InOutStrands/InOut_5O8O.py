...
cmd.select("Astrand9", "resi 170+171+172+173+174+175+176+177+178+179+180+181+182 & chain A ")


cmd.select("Astrand10", "resi 187+188+189+190+191+192+193+194+195+196+197 & chain A ")


cmd.select("Astrand11", "resi 204+205+206+207+208+209+210+211+212+213+214+215 & chain A ")


cmd.select("Astrand12", "resi 220+221+222+223+224+225 & chain A ")


cmd.select("Astrand13", "resi 231+232+233+234+235+236+237+238 & chain A ")


cmd.select("Astrand14", "resi 243+244+245+246+247+248+249+250+251+252 & chain A ")


cmd.select("Astrand15", "resi 266+267+268+269+270+271+272+273+274+275 & chain A ")


cmd.select("Astrand16", "resi 280+281+282+283+284+285+286+287+288 & chain A ")


cmd.select("Astrand17", "resi 291+292+293+294+295+296+297+298+299 & chain A ")


cmd.select("Astrand18", "resi 305+306+307+308+309+310+311+312+313+314 & chain A ")


cmd.select("Astrand19", "resi 319+320+321+322+323+324+325+326+327+328+329 & chain A ")
...
cmd.load_cgo( [9.0, -20.75163,2.5639994,-1.5856314, -26.449366, 3.3235786, 18.675262, 1, 1,1,0,0,0,1], "axis" )

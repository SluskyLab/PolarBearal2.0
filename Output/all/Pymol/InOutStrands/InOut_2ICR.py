...
cmd.select("Astrand5", "resi 119+120+121+122+123+124+125+126+127+128+129 & chain A ")
...
cmd.select("Astrand9", "resi 176+177+178+179+180+181+182+183+184+185+186+187 & chain A ")


cmd.select("Astrand8", "resi 160+161+162+163+164+165+166+167+168+169+170+171 & chain A ")


cmd.select("Astrand6", "resi 142+143+144+145+148+149+150+151+152+153+154+155 & chain A ")


cmd.select("Astrand10", "resi 198+199+200+201+202+203+204+205+206+207+208 & chain A ")


cmd.select("Astrand11", "resi 216+217+218+219+220+221+222+223+224+225+226 & chain A ")
...
cmd.load_cgo( [9.0, -63.109276,-10.037182,-12.374363, -43.873817, -25.57791, -15.995728, 1, 1,1,0,0,0,1], "axis" )

...
cmd.color ("blue", "resi 109 & chain I")

cmd.select ("Outward", "resi 109 & chain I", merge=1)

cmd.color ("blue", "resi 110 & chain I")

cmd.select ("Outward", "resi 110 & chain I", merge=1)

cmd.color ("blue", "resi 111 & chain I")

cmd.select ("Outward", "resi 111 & chain I", merge=1)

cmd.color ("blue", "resi 112 & chain I")

cmd.select ("Outward", "resi 112 & chain I", merge=1)

cmd.color ("blue", "resi 113 & chain I")

cmd.select ("Outward", "resi 113 & chain I", merge=1)

cmd.color ("blue", "resi 114 & chain I")

cmd.select ("Outward", "resi 114 & chain I", merge=1)

cmd.color ("blue", "resi 115 & chain I")

cmd.select ("Outward", "resi 115 & chain I", merge=1)

cmd.color ("blue", "resi 122 & chain I")

cmd.select ("Outward", "resi 122 & chain I", merge=1)

cmd.color ("blue", "resi 123 & chain I")

cmd.select ("Outward", "resi 123 & chain I", merge=1)

cmd.color ("blue", "resi 124 & chain I")

cmd.select ("Outward", "resi 124 & chain I", merge=1)

cmd.color ("blue", "resi 125 & chain I")

cmd.select ("Outward", "resi 125 & chain I", merge=1)

cmd.color ("blue", "resi 126 & chain I")

cmd.select ("Outward", "resi 126 & chain I", merge=1)

cmd.color ("blue", "resi 127 & chain I")

cmd.select ("Outward", "resi 127 & chain I", merge=1)

cmd.color ("blue", "resi 128 & chain I")

cmd.select ("Outward", "resi 128 & chain I", merge=1)

cmd.load_cgo( [9.0, -7.6583753,36.1955,87.80275, -2.6197505, 28.222376, 97.617004, 1, 1,1,0,0,0,1], "axis" )

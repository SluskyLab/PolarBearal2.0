...
cmd.select("Astrand7", "resi 97+98+99+100+101+102+103+104 & chain A ")


cmd.select("Astrand6", "resi 85+86+87+88+89+90+91+92+93+94 & chain A ")


cmd.select("Astrand5", "resi 77+78+79+80 & chain A ")


cmd.select("Astrand4", "resi 69+70+71+72+73 & chain A ")
...
cmd.load_cgo( [9.0, 10.344625,39.708126,43.907623, 20.941874, 42.81687, 45.980125, 1, 1,1,0,0,0,1], "axis" )

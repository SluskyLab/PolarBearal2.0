...
cmd.select("Astrand7", "resi 102+103+104+105+106+107+108+109+110 & chain A ")


cmd.select("Astrand6", "resi 91+92+93+94+95+96+97 & chain A ")


cmd.select("Astrand5", "resi 79+80+81+82+83+84+85+86+87+88 & chain A ")
...
cmd.load_cgo( [9.0, 30.000628,34.836002,7.4738746, 13.449875, 29.288874, 10.870125, 1, 1,1,0,0,0,1], "axis" )

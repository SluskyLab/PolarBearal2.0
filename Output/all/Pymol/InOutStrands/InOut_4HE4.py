...
cmd.select("Astrand5", "resi 116+117+118+119+120+121+122+123+124+125+126 & chain A ")


cmd.select("Astrand4", "resi 103+104+105+106+107+108+109+110+111+112+113 & chain A ")


cmd.select("Astrand3", "resi 90+91+92+93+94+95+96+97+98 & chain A ")


cmd.select("Astrand6", "resi 146+147+148+149+150+151+152+153 & chain A ")


cmd.select("Astrand7", "resi 158+159+160+161+162+163+164+165+166+167+168 & chain A ")


cmd.select("Astrand8", "resi 176+177+178+179+180+181+182+183+184+185+186+187 & chain A ")


cmd.select("Astrand9", "resi 199+200+201+202+203+204+205+206+207+208 & chain A ")


cmd.select("Astrand10", "resi 217+218+219+220+221+222+223+224+225+226+227 & chain A ")


cmd.select("Astrand2", "resi 41+42+43+44+45+46+47+48 & chain A ")
...
cmd.load_cgo( [9.0, 28.435637,16.297638,10.145637, 28.435637, 16.297638, 10.145637, 1, 1,1,0,0,0,1], "axis" )

...
cmd.select("Astrand4", "resi 88+89+90+91+92+93+94+95+96 & chain A ")


cmd.select("Astrand10", "resi 169+170+171+172+173+174+175+176+177+178+179+180 & chain A ")


cmd.select("Astrand9", "resi 153+154+155+156+157+158+159+160+161+162+163+164 & chain A ")


cmd.select("Astrand7", "resi 137+138+139+140+143+144+145+146+147+148+150+149 & chain A ")


cmd.select("Astrand11", "resi 193+194+195+196+197+198+199+200+201+202+203+204+205 & chain A ")


cmd.select("Astrand12", "resi 210+211+212+213+214+215+216+217+218+219+220 & chain A ")
...
cmd.load_cgo( [9.0, 18.972,-11.459727,-1.9000001, 43.491726, -14.925, 1.5679091, 1, 1,1,0,0,0,1], "axis" )

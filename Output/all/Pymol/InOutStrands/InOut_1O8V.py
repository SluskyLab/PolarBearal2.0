...
cmd.select("Astrand7", "resi 101+102+103+104+105+106+107+108+109+110 & chain A ")


cmd.select("Astrand6", "resi 91+92+93+94+95+96+97+98 & chain A ")


cmd.select("Astrand5", "resi 82+83+84+85+86+87+88 & chain A ")


cmd.select("Astrand4", "resi 69+70+71+72+73+74+75 & chain A ")


cmd.select("Astrand3", "resi 60+61+62+64 & chain A ")


cmd.select("Astrand2", "resi 49+50+51+52+53+54+55+56 & chain A ")
...
cmd.load_cgo( [9.0, 3.2225997,-5.0973997,5.5883994, 3.2225997, -5.0973997, 5.5883994, 1, 1,1,0,0,0,1], "axis" )

...
cmd.select("Astrand10", "resi 201+202+203+204+205+206+207+208+209+210+211+212+213+214 & chain A ")


cmd.select("Astrand5", "resi 124+125+126+127+128+129+130+131+132+133+134+135 & chain A ")


cmd.select("Astrand9", "resi 185+186+187+188+189+190+191+192+193+194+195+196+197+198 & chain A ")
...
cmd.select("Astrand3", "resi 78+79+80+81+82+83 & chain A ")


cmd.select("Astrand2", "resi 54+55+56+57+58+59+60+61+62 & chain A ")


cmd.select("Astrand1", "resi 40+41+42+43+44+45+46+47 & chain A ")
...
cmd.load_cgo( [9.0, 35.024437,-4.752562,55.315434, 35.024437, -4.752562, 55.315434, 1, 1,1,0,0,0,1], "axis" )

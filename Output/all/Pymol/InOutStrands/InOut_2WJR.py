...
cmd.select("Astrand9", "resi 127+128+129+130+131+132+133+134+135+136+137 & chain A ")


cmd.select("Astrand10", "resi 142+143+144+145+146+147+148+149+150+151+152+153 & chain A ")


cmd.select("Astrand11", "resi 165+166+167+168+169+170+171+172+173+174+175 & chain A ")


cmd.select("Astrand12", "resi 181+182+183+184+185+186+187+188+189 & chain A ")


cmd.select("Astrand15", "resi 205+206+207+208+209+210+211+212+213 & chain A ")
...
cmd.load_cgo( [9.0, 5.3437505,-21.002668,-8.8075, 5.3437505, -21.002668, -8.8075, 1, 1,1,0,0,0,1], "axis" )

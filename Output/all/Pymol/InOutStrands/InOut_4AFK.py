...
cmd.select("Astrand19", "resi 479+480+481+482+483+484+485+486+487+488+489 & chain A ")


cmd.select("Astrand18", "resi 457+458+459+460+461+462+463+464+465+466+467 & chain A ")


cmd.select("Astrand17", "resi 425+426+427+428+429+430+431+432+433+434+435+436+437 & chain A ")


cmd.select("Astrand16", "resi 392+393+394+395+396+397+398+399+400+401+402+403 & chain A ")


cmd.select("Astrand15", "resi 377+378+379+380+381+382+383+384+385+386+387+388 & chain A ")


cmd.select("Astrand12", "resi 324+325+326+327+328+329+330+331+332+333 & chain A ")


cmd.select("Astrand11", "resi 297+298+299+300+301+302+303+304+305+306+307+308+309+310+311+312+313+314+315+316+317+318+319 & chain A ")


cmd.select("Astrand10", "resi 272+273+274+275+276+277+278+279+280+281+282+283+284+285+286+287+288+289+290+291+292 & chain A ")


cmd.select("Astrand9", "resi 248+249+250+251+252+253+254+255+256+257+258+259+260+261 & chain A ")


cmd.select("Astrand8", "resi 219+220+221+222+223+224+225+226+227+228+229+230 & chain A ")


cmd.select("Astrand7", "resi 204+205+206+207+208+209+210+211+212+213+214+215+216 & chain A ")


cmd.select("Astrand6", "resi 177+178+179+180+181+182+183+184+185 & chain A ")


cmd.select("Astrand5", "resi 162+163+164+165+166+167+168+169+170+171+172+173 & chain A ")


cmd.select("Astrand4", "resi 144+145+146+147+148+149+150+151+152+153+154 & chain A ")


cmd.select("Astrand3", "resi 124+125+126+127+128+129+130+131+132+133+134+135 & chain A ")


cmd.select("Astrand2", "resi 84+85+86+87+88+89+90+91+92+93+94+95 & chain A ")


cmd.select("Astrand1", "resi 66+67+68+69+70+71+72+73+74+75+76+77+78+79+80+81 & chain A ")
...
cmd.load_cgo( [9.0, 14.903554,-2.070222,18.649944, 14.903554, -2.070222, 18.649944, 1, 1,1,0,0,0,1], "axis" )

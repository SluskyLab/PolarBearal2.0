...
cmd.color("wheat","all")
cmd.select("Astrand1", "resi 24+25+26+27+28+29+30+31 & chain A ")


cmd.select("Astrand7", "resi 108+109+110+111+112+113+114+115+116 & chain A ")


cmd.select("Astrand6", "resi 96+97+98+99+100+101+102+103 & chain A ")


cmd.select("Astrand5", "resi 84+85+86+87+88 & chain A ")


cmd.select("Astrand4", "resi 67+68+69+70+71+72+73+74+75+76 & chain A ")


cmd.select("Astrand8", "resi 121+122+123+124+125+126+127+128+129+130 & chain A ")


cmd.select("Astrand3", "resi 54+55+56+57+58+59+60+61 & chain A ")


cmd.select("Astrand2", "resi 40+41+42+43+44+45+46+47+48 & chain A ")
...
cmd.load_cgo( [9.0, 7.25375,31.667625,54.443253, 7.25375, 31.667625, 54.443253, 1, 1,1,0,0,0,1], "axis" )

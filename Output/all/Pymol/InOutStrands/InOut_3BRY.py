...
cmd.select("Astrand5", "resi 233+234+235+236+150+237+151+152+238+153+239+154+240+155+156+157+158+159+160+161+162+163+248+164+165+249+250+166+167+251+169+168+252 & chain A ")
...
cmd.select("Astrand10", "resi 268+269+270+271+272+273+280+281+282+283+284+285+286+287+288 & chain A ")


cmd.select("Astrand12", "resi 293+294+295+296+297+298+299+300+301+302+311+310+312+313+314+315 & chain A ")


cmd.select("Astrand15", "resi 335+336+337+338+339+340+341+342+343+344+345+346+347 & chain A ")


cmd.select("Astrand16", "resi 350+351+352+353+354+355+356+357+358+359+360 & chain A ")


cmd.select("Astrand17", "resi 378+379+380+381+382+383+384+385+386+387 & chain A ")


cmd.select("Astrand18", "resi 392+393+394+395+396+397+398+399+400+401 & chain A ")


cmd.select("Astrand19", "resi 420+421+422+423+424+425+426+427+428+429+430+431+432+433+434+435 & chain A ")
...
cmd.load_cgo( [9.0, 43.632248,-12.972084,-42.001087, 43.632248, -12.972084, -42.001087, 1, 1,1,0,0,0,1], "axis" )

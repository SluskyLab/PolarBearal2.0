...
cmd.select("Astrand7", "resi 118+119+120+121+122+123 & chain A ")


cmd.select("Astrand6", "resi 102+103+104+105+106+107+108 & chain A ")
...
cmd.select("Astrand2", "resi 54+55+56+57+58+59 & chain A ")


cmd.select("Astrand1", "resi 147+148+149+150+42+43+44+45+46+47+48 & chain A ")
...
cmd.load_cgo( [9.0, 36.128254,-26.591251,12.312624, 36.128254, -26.591251, 12.312624, 1, 1,1,0,0,0,1], "axis" )

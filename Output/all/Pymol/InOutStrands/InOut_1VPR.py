...
cmd.zoom("barrel")
cmd.color ("red", "resi 1028 & chain A")

cmd.select ("Inward", "resi 1028 & chain A", merge=1)
...
cmd.color ("red", "resi 1072 & chain A")

cmd.select ("Inward", "resi 1072 & chain A", merge=1)

cmd.color ("blue", "resi 1073 & chain A")

cmd.select ("Outward", "resi 1073 & chain A", merge=1)

cmd.color ("red", "resi 1074 & chain A")

cmd.select ("Inward", "resi 1074 & chain A", merge=1)

cmd.color ("blue", "resi 1075 & chain A")

cmd.select ("Outward", "resi 1075 & chain A", merge=1)

cmd.color ("red", "resi 1076 & chain A")

cmd.select ("Inward", "resi 1076 & chain A", merge=1)
...
cmd.color ("red", "resi 1151 & chain A")

cmd.select ("Inward", "resi 1151 & chain A", merge=1)

cmd.color ("blue", "resi 1152 & chain A")

cmd.select ("Outward", "resi 1152 & chain A", merge=1)

cmd.color ("red", "resi 1153 & chain A")

cmd.select ("Inward", "resi 1153 & chain A", merge=1)

cmd.color ("blue", "resi 1154 & chain A")

cmd.select ("Outward", "resi 1154 & chain A", merge=1)

cmd.color ("red", "resi 1155 & chain A")

cmd.select ("Inward", "resi 1155 & chain A", merge=1)

cmd.color ("blue", "resi 1156 & chain A")

cmd.select ("Outward", "resi 1156 & chain A", merge=1)

cmd.color ("red", "resi 1157 & chain A")

cmd.select ("Inward", "resi 1157 & chain A", merge=1)

cmd.color ("blue", "resi 1158 & chain A")

cmd.select ("Outward", "resi 1158 & chain A", merge=1)

cmd.color ("red", "resi 1159 & chain A")

cmd.select ("Inward", "resi 1159 & chain A", merge=1)
...
cmd.color ("red", "resi 1171 & chain A")

cmd.select ("Inward", "resi 1171 & chain A", merge=1)

cmd.color ("blue", "resi 1172 & chain A")

cmd.select ("Outward", "resi 1172 & chain A", merge=1)

cmd.load_cgo( [9.0, 41.91175,69.37175,48.5925, 41.91175, 69.37175, 48.5925, 1, 1,1,0,0,0,1], "axis" )

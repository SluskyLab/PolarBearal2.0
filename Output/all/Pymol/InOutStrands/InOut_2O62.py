...
cmd.color("wheat","all")
cmd.select("Astrand9", "resi 144+145+146+147+148+149+150+151+152+153+154 & chain A ")


cmd.select("Astrand10", "resi 161+162+163+164+165+166+167+168+169+170+171 & chain A ")


cmd.select("Astrand11", "resi 177+178+179+180+181+182+183 & chain A ")


cmd.select("Astrand12", "resi 186+187+188+189+190+191+192+193+194+195 & chain A ")


cmd.select("Astrand13", "resi 198+199+200+201 & chain A ")


cmd.select("Astrand14", "resi 209+210+211+212+213 & chain A ")


cmd.select("Astrand15", "resi 218+219+220+221+222+223 & chain A ")


cmd.select("Astrand16", "resi 232+233+234+235+236+237+238+239+240+241 & chain A ")


cmd.select("Astrand17", "resi 244+245+246+247+248+249+250+251+252 & chain A ")


cmd.select("Astrand18", "resi 258+259+260+261+262+263+264+265+266+267+268 & chain A ")
...
cmd.load_cgo( [9.0, 5.1489,-1.4985998,30.430496, 5.1489, -1.4985998, 30.430496, 1, 1,1,0,0,0,1], "axis" )
